			...
			<div class="row">  
				<div class="span8">  
					<ul class="nav nav-tabs nav-stacked">  
						...
						<li><a href="#"><img id="apptIcon" src="assets/img/apptIcon.png" alt="Appointment Icon"/></i>Appointment</a></li>  
						<li><a href="#"><img id="messageIcon" src="assets/img/messageIcon.png" alt="Message Icon"/>Message</a></li>   
						<li><a href="#"><i class="fa fa-clipboard"></i>Medical Info</a></li> 
						<li><a href="#"><i class="fa fa-stethoscope"></i>Tests</a></li>
						<li><a href="#"><i class="fa fa-plus-square"></i>Prescriptions</a></li>   
